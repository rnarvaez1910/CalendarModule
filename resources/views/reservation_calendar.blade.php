...
@section ('admincontent')
  ...
  <div class="modal-bg" id="modalReserva">
    ...
    <form class="d-flex flex-column gap-2" id="formReserva" onsubmit="enviarReserva(event)">
      <div>
      <input id="fechaReserva" type="date" required />
      </div>
      <div class="d-flex gap-2">
      <input id="horaInicio" style="width:3rem;" type="number" max="23" min="0" required placeholder="hh" />
      <span>:</span>
      <input id="minutoInicio" style="width:3rem;" type="number" max="59" min="0" required placeholder="mm" />
      <span>-</span>
      <input id="horaFin" style="width:3rem;" type="number" max="23" min="0" required placeholder="hh" />
      <span>:</span>
      <input id="minutoFin" style="width:3rem;" type="number" max="59" min="0" required placeholder="mm" />
      </div>
